export const checkCollision = (boxA, boxB) => {
...
export const getOffset = (element, pointer) => {
...
export const getDelta = (pointA, pointB) => ({
    x: pointB.x - pointA.x,
    y: pointB.y - pointA.y,
});
...
export const getAngle = (pointA, pointB) => {
    const dx = pointB.x - pointA.x;
    const dy = pointB.y - pointA.y;
    return Math.atan2(dy, dx) * (180 / Math.PI);
};
export const createGrid = (element, options) => {
